...
export const AuthProviders = ({ to, label }: AuthProps) => {
    return (
        <div>
            ...
            <button type="button" className="flex justify-center border drop-shadow-md bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-semibold font-poppins rounded-lg text-base px-5 py-2.5 text-center items-center dark:focus:ring-gray-500 dark:hover:bg-gray-700 me-2 my-3 w-full">
            ...
            <button type="button" className="flex justify-center border drop-shadow-md bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-semibold font-poppins rounded-lg text-base px-5 py-2.5 text-center items-center dark:focus:ring-gray-500 dark:hover:bg-gray-700 me-2 my-6 w-full">
