    ...
    return (<Card title='balanceCard'>
        ...
        <div className='flex justify-between pb-1 mb-4 border-b font-poppins dark:border-gray-700 text-gray-900 dark:text-white'>
            <div className='flex'>
                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger><img width="25" src="https://img.icons8.com/plasticine/100/question-mark.png" alt="question-mark" /></TooltipTrigger>
                        <TooltipContent>
                            <p>This is the amount of money that is immediately available for use or transfer.</p>
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>
            ...
            <div className='flex'>
                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger><img width="25" src="https://img.icons8.com/plasticine/100/question-mark.png" alt="question-mark" /></TooltipTrigger>
                        <TooltipContent>
                            <p>This amount is temporarily unavailable for withdrawal or use, possibly due to transaction holds or account restrictions.</p>
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>
            </div>
